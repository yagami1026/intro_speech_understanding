...
def copy_all_but_skip_word(input_list, skip_word):   
    '''
    This function should copy elements one by one from input list into output list.
    If one of the elements is equal to the skip word, then you should skip that element,
...
def my_average(input_list):  
    '''
    You may assume that `input list*is a non-empty list, in which every element is a number.
